        ...
        {isLoggedIn && (
          <div className="relative flex items-center gap-2">
            ...
            <div className="relative">
              ...
              {notifDrop && (
                <div data-dropdown-box="true" className={`absolute right-0 top-full z-50 mt-2 w-[min(26rem,calc(100vw-2rem))] rounded-3xl border border-[#00f5ff]/70 bg-black/95 p-4 shadow-2xl animate-fade-in ${NAV_DROPDOWN_LAYER_CLASS}`}>
            ...
            <div className="relative">
              ...
              {shareOpen ? (
                <div data-dropdown-box="true" className={`absolute right-0 top-full z-50 mt-2 w-[min(26rem,calc(100vw-2rem))] rounded-3xl border border-[#00f5ff]/70 bg-black/95 p-3 shadow-2xl animate-fade-in ${NAV_DROPDOWN_LAYER_CLASS}`}>
            ...
            <div className="relative">
              ...
              {settingsOpen && (
                <div data-dropdown-box="true" className={`absolute right-0 top-full z-50 mt-2 w-[min(26rem,calc(100vw-2rem))] rounded-3xl border border-[#00f5ff]/70 bg-black/95 p-2 shadow-2xl animate-fade-in ${NAV_DROPDOWN_LAYER_CLASS}`}>
